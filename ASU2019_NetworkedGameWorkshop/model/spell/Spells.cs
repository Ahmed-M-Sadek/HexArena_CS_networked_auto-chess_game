...
namespace ASU2019_NetworkedGameWorkshop.model.spell
{
    public class Spells
    {
        ...
        public static readonly Spells Heal = new Spells(1000, new Target(false, PriorityType.Self), new SpellType(new StatusEffect(StatusType.HealthPoints,1000,2000,StatusEffect.StatusEffectType.Adder)), "../../assets/sprites/spells/heal-jade-1.png");
